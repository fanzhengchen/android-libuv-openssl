...
# openssl-OpenSsl-1_0_2k.tar.gz
# openssl-OpenSSL_1_0_2k.tar.gz
#[ ! -f openssl-1.0.2k.tar.gz ] && {
...
./Configure android --prefix=${PREFIX} shared no-ssl2 no-ssl3 no-comp no-hw no-engine
